/* =============================================================================
   ...
   ============================================================================= */
(function () {
  // Kelsi Kee's tag + interest group in the shared RAREROOM audience. The three
  ...
  const SEEN_KEY = 'kelsikee-signup-popup';
  ...
  function build() {
    ...
    pop.innerHTML =
      ...
      '<p class="signup-pop__consent">By subscribing you agree to receive emails from Kelsi Kee. ' +
  ...
  function open() {
    ...
    document.querySelectorAll('#main-nav a, #social a').forEach(function (item) {
